...
class BinanceAPI(object):
    ...
    def withdraw(self, **params):
        ...
        expample
            withdraw(asset=asset, address=address, amount=amount, name=name)
        """
